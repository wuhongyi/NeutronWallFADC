...
// Last-Updated: Mon Jul  9 13:47:09 2018 (-0400)
//           By: Hongyi Wu(吴鸿毅)
//     Update #: 38
...
int main(int argc, char *argv[])
{
  ...
  chain->Add("$Dir/../data/run_131*_fadc_14.root");//采用通配符
  chain->Add("$Dir/../data/run_132*_fadc_14.root");//采用通配符
  chain->Add("$Dir/../data/run_133*_fadc_14.root");//采用通配符
